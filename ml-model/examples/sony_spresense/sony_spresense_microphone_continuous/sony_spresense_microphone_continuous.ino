...
/* Includes ---------------------------------------------------------------- */
#include <final_final_inferencing.h>
 ...
 * Set in bps.
 */
static const int32_t recording_bitrate = ei_default_impulse.frequency;
/**
 * number of channels
 */
static const uint8_t recording_channels = ei_default_impulse.raw_samples_per_frame;
...
void loop()
{
    ...
    signal_t signal;
    signal.total_length = ei_default_impulse.slice_size * ei_default_impulse.raw_samples_per_frame;
...
static bool microphone_inference_start(void)
{   
    inference.buffers[0] = (int16_t *)ei_aligned_calloc(32, ei_default_impulse.slice_size * sizeof(int16_t) * recording_channels);
    inference.buffers[1] = (int16_t *)ei_aligned_calloc(32, ei_default_impulse.slice_size * sizeof(int16_t) * recording_channels);
    ...
    inference.n_samples  = ei_default_impulse.slice_size;
