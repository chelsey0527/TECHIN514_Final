...
void loop()
{
    ...
    signal_t signal;
    signal.total_length = ei_default_impulse.dsp_input_frame_size;
...
static bool microphone_inference_start(void)
{   
    inference.buffer = (int16_t *)ei_aligned_calloc(32, ei_default_impulse.raw_sample_count * sizeof(int16_t) * recording_channels);
    ...
    inference.n_samples  = ei_default_impulse.raw_sample_count;
